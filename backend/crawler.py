...
if __name__ == '__main__':
	...
	global_cities = ['Owerri', 'Goiania', 'Milan', 'Guarulhos', 'Juarez', 'Barranquilla', 'Calgary', 'Abuja', 'Vila Velha', 'Mombasa', 'Maiduguri', 'Benin City', 'Cilacap', 'Bandar Lampung', 'Campinas', 'Zapopan', 'Ciudad Nezahualcoyotl', 'Nezahualcoyotl', 'Sevilla', 'Mexicali', 'Ikare', 'Sao Goncalo', 'Vereeniging', 'Sao Luis', 'Edmonton', 'Bogor', 'Cartagena', 'Ogbomoso', 'Maceio', 'Patam', 'Shubra al Khaymah', 'Nice', 'Port Harcourt']
